...
type Payload struct {
    ...
    Symbol []string `json:"symbol"` //luu coin(BTC BNB) user dang ki
    Threshold []float64 `json:"threshold"`// (TH BTC, TH BNB)
    Lower bool `json:"lower"` // true: lower than TH || false: nguoc lai
}
